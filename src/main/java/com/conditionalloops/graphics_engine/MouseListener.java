...
public class MouseListener {
  ...
  private MouseListener() {
    ...
    /**
     * values are 0 by default, but this states the intention explicitly.
     */
    this.scrollX = 0.0;
    this.scrollY = 0.0;
    ...
    for(int i = 0; i < this.mouseButtonPressed.length; ++i){
  ...
  public static boolean isMouseButtonDown(int mouseButton) {
    return mouseButton < get().mouseButtonPressed.length && get().mouseButtonPressed[mouseButton];
  }
}
